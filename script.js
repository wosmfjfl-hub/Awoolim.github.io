...
function showResult() {
    ...
    // Get the result data from the pre-defined object
    const result = resultsData[resultType];
    // Add the class to the container for the specific result type
...
copyBtn.addEventListener('click', () => {
    ...
    resultDescriptionSections.forEach(section => {
        ...
        resultText += '\n'; // Add a newline after each section for better formatting
    });
