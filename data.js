...
const resultsData = {
    'LP': {
        ...
        compatibility: {
            best: { type: 'LR', text: '안정적인 뿌리 리더가 당신의 에너지를 현실적으로 뒷받침해주며, 함께 큰 성과를 만들 수 있습니다.' },
            good: { type: 'FR', text: '섬세한 공명자가 팀의 감정을 챙겨주어, 당신이 리더십을 발휘하는 데만 집중할 수 있도록 돕습니다.' }
        },
        details: [
    ...
    'LC': {
        ...
        compatibility: {
            best: { type: 'LE', text: '열정적인 불꽃 리더의 추진력에 당신의 안정적인 조율 능력이 더해져 최고의 시너지를 발휘합니다.' },
            good: { type: 'FE', text: '넘치는 에너지의 에너자이저와 함께하면 팀 분위기를 항상 즐겁고 활기차게 유지할 수 있습니다.' }
        },
        details: [
    ...
    'LE': {
        ...
        compatibility: {
            best: { type: 'LC', text: '유연한 유재석형 리더가 당신의 불꽃같은 열정이 올바른 방향으로 타오르도록 든든하게 지원합니다.' },
            good: { type: 'FR', text: '따뜻한 공명자가 당신이 놓칠 수 있는 팀원들의 감정을 세심하게 챙겨 완벽한 팀워크를 만듭니다.' }
        },
        details: [
    ...
    'LR': {
        ...
        compatibility: {
            best: { type: 'LP', text: '현장을 압도하는 강호동형 리더와 함께라면, 당신이 다져놓은 안정적인 기반 위에서 위대한 도전을 시작할 수 있습니다.' },
            good: { type: 'FE', text: '활기찬 에너자이저가 팀에 생동감을 불어넣어, 자칫 무거워질 수 있는 분위기를 즐겁게 만듭니다.' }
        },
        details: [
    ...
    'FE': {
        ...
        compatibility: {
            best: { type: 'FR', text: '섬세한 공명자가 당신의 넘치는 에너지를 따뜻하게 감싸주며, 함께 긍정적인 분위기를 만들어냅니다.' },
            good: { type: 'LC', text: '안정적인 유재석형 리더의 계획 안에서 당신의 에너지가 더욱 효과적으로 발휘될 수 있습니다.' }
        },
        details: [
    ...
    'FR': {
        ...
        compatibility: {
            best: { type: 'FE', text: '활기찬 에너자이저와 함께하면 당신의 섬세함이 팀 전체에 긍정적인 영향력을 미치게 됩니다.' },
            good: { type: 'LE', text: '열정적인 불꽃 리더의 곁에서 당신은 팀의 균형을 맞추는 핵심적인 역할을 수행할 수 있습니다.' }
        },
        details: [
