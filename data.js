...
const questionPool = {
    lead: [
        ...
        { question: "나는 팀에서 '주도자' 역할을 맡는 경우가 많다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "팀원 간 갈등이 생기면, 직접 나서서 문제를 해결하려고 한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "팀의 성과가 부진할 때, 새로운 전략을 가장 먼저 제안하는 편이다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 논의가 길어질 때, 결론을 내리고 다음 단계로 나아가는 것을 선호한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "결정이 필요한 상황에서, 나는 망설이기보다 과감하게 선택하는 편이다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
    ],
    flow: [
        ...
        { question: "팀에서 안정적이고 조화로운 역할을 맡는 것이 편하다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 팀의 안정적인 관계를 유지하는 것이 성과보다 더 중요하다고 생각한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "다른 사람들이 결정을 내리면, 나는 그 결정이 잘 실행되도록 돕는 역할에 만족한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 리더를 보조하고 팀원들을 지원하는 역할에서 더 큰 만족을 느낀다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "다른 사람의 좋은 아이디어를 듣고, 그것을 발전시키도록 돕는 것을 즐긴다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
    ],
    expression: [
        ...
        { question: "단기적 성과나 눈에 보이는 결과가 나를 동기부여한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 텍스트 메시지보다 전화나 직접 만나서 대화하는 것을 선호한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 좋은 일이 생기면 주변 사람들에게 바로 알리고 함께 기쁨을 나누고 싶어한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 내 생각을 말할 때, 서론이 길기보다 핵심부터 바로 이야기한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
    ...
    response: [
        ...
        { question: "장기적 신뢰와 관계 안정이 나에게 더 중요하다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 상대방이 말을 끝내기 전에 끼어들기보다, 끝까지 듣고 의도를 파악하려고 한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 단체 채팅방에서 메시지를 보내기 전에 여러 번 읽고 수정한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        { question: "나는 내 속마음을 이야기하기보다, 상대방의 이야기를 들어주는 역할이 더 익숙하다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
    ],
    mbti: {
        ei: [ // 점수가 높을수록 E (외향)
            ...
            { question: "나는 주말에 약속이 없으면 심심하고 허전하게 느껴진다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
            { question: "나는 생각을 정리할 때 다른 사람과 대화하며 소리 내어 말하는 것을 선호한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
        ],
        sn: [ // 점수가 높을수록 S (감각)
            ...
            { question: "나는 추상적이거나 이론적인 이야기보다 구체적이고 현실적인 대화를 선호한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
            ...
            { question: "나는 새로운 개념을 배울 때, 구체적인 예시나 실제 사례를 통해 더 잘 이해한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
        ],
        tf: [ // 점수가 높을수록 F (감정)
            { question: "나는 결정을 내릴 때, 논리적인 분석보다 사람들과의 관계나 감정을 우선적으로 고려한다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
            ...
            { question: "나는 누군가를 위로할 때, 현실적인 해결책보다 먼저 따뜻한 말로 공감해주는 편이다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
        ...
        jp: [ // 점수가 높을수록 J (판단)
            ...
            { question: "나는 내 생활 공간이 잘 정돈되어 있을 때 마음이 편안하다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] },
            ...
            { question: "나는 갑작스러운 계획 변경이 생기면 스트레스를 받는 편이다.", options: [{ text: "매우 아니다", score: 1 }, { text: "아니다", score: 2 }, { text: "보통이다", score: 3 }, { text: "그렇다", score: 4 }, { text: "매우 그렇다", score: 5 }] }
        ]
    }
};
...
const resultsData = {
    'LP': {
        ...
        details: [
            ...
            { type: 'p', content: '쇼맨형은 다른 유형들이 지쳤을 때 나서서 팀의 에너지를 끌어올리고, 유연하게 돌아가는 시스템을 만들 수 있도록 돕습니다. 특히 **백본형(LR)**과 함께하면, 강력한 추진력을 바탕으로 새로운 목표에 도전할 수 있습니다. 이처럼 쇼맨형은 단단한 기반 위에서 팀의 성장 동력을 확보하는 핵심적인 역할을 수행합니다.' },
    ...
    'LC': {
        ...
        details: [
            ...
            { type: 'p', content: '밸런서형은 쇼맨형이 에너지를 모두 쏟아냈을 때, 팀의 중심을 잡아주고 장기적인 안정성을 확보하는 역할을 합니다. 특히 **스파크형(LE)**과 함께하면, 스파크형의 추진력이 지나쳐 장기적 성과를 놓치는 것을 막고, 팀원들의 의견을 모아 균형 잡힌 방향으로 나아가도록 조율합니다. 밸런서형은 팀이 지치거나 갈등을 겪을 때 나서서 팀의 에너지를 회복시키는 중요한 역할을 수행합니다.' },
            { type: 'h3', content: '📈 성장 & 자기 계발 조언' },
    ...
    'LE': {
        ...
        details: [
            ...
            { type: 'p', content: '당신은 불꽃처럼 강렬하고, 어느 자리든 단숨에 주목받는 리더입니다. 새로운 아이디어가 떠오르면 망설임 없이 행동으로 옮기며, 주변 사람들의 관심과 에너지를 순식간에 끌어올립니다. 팀이 막막해 하거나 위기에 처했을 때도 당황하지 않고 앞장서서 방향을 제시하며, 짧은 시간 안에 분위기를 집중시키는 능력이 탁월합니다. 순간적인 열정과 카리스마로 모두를 몰입하게 만들지만, 장기적인 계획이나 세부적인 조율은 다소 부족할 수 있습니다. 그래서 스파크형은 **‘순간의 힘’과 ‘즉각적인 몰입’**을 팀에 불어넣는 존재이며, 주변 사람들에게 영감과 동기를 주는 역할을 합니다.' },
            { type: 'h3', content: '강점' },
            ...
            { type: 'h3', content: '⚡ 다른 유형과의 시너지' },
            { type: 'p', content: '스파크형은 **백본형(LR)**의 장기적인 안정감과 만나면, 불꽃처럼 타오르는 에너지가 지속 가능한 성과로 이어질 수 있습니다. 팀이 지칠 때 서로 역할을 바꾸며 유기적으로 순환할 때 가장 큰 시너지를 냅니다.' },
            { type: 'h3', content: '📈 성장 & 자기 계발 조언' },
    ...
    'LR': {
        ...
        title: '🌱 백본형 (LR)',
        similarMbti: 'ISTJ, ESTJ',
        description: '팀의 기반을 단단히 다지며 안정감을 선사하는 백본',
        ...
        details: [
            ...
            { type: 'h3', content: '🌱 다른 유형과의 시너지' },
            { type: 'p', content: '백본형은 **스파크형(LE)**의 강렬한 추진력을 바탕으로 새로운 도전을 시도할 수 있습니다. 스파크형이 지칠 때 백본형이 나서서 팀의 안정적인 흐름을 유지합니다. 두 유형이 서로의 장점을 존중하며 역할을 순환할 때, 팀은 단기적 성과와 장기적 성장을 모두 잡을 수 있습니다.' },
            { type: 'h3', content: '📈 성장 & 자기 계발 조언' },
    ...
    'FE': {
        ...
        details: [
            ...
            { type: 'p', content: '당신은 어디서든 활력을 불어넣는 인싸형입니다. 자유롭고 창의적인 발상으로 팀의 흐름을 신선하게 만들고, 상황에 따라 유연하게 반응하며 즉흥적으로 문제를 해결하는 능력을 지니고 있습니다. 함께 있는 사람들에게 즐거움과 활기를 전달하며, 팀의 ‘분위기 메이커’로 자연스럽게 중심이 됩니다. 당신이 있는 곳에는 활기가 넘치고, 주변 사람들은 에너지에 자극을 받아 더욱 몰입하게 됩니다. 다만, 순간의 흥분과 다채로운 아이디어에 치중하다 보면 집중력이 떨어지거나 장기 계획과 현실적 제약을 간과할 수 있습니다.' },
            { type: 'h3', content: '강점' },
            ...
            { type: 'h3', content: '🌟 다른 유형과의 시너지' },
            { type: 'p', content: '인싸형은 **힐러형(FR)**의 섬세한 조율 능력과 만나면 더욱 빛을 발합니다. 힐러형이 팀의 감정선을 읽고 조화를 만들어낼 때, 인싸형은 활력을 불어넣어 팀의 사기를 높여줍니다. 서로의 강점을 보완하며, 팀 전체가 감정적, 심리적으로 안정된 상태에서 능동적으로 움직일 수 있도록 돕습니다.' },
            { type: 'h3', content: '📈 성장 & 자기 계발 조언' },
    ...
    'FR': {
        ...
        details: [
            ...
            { type: 'h3', content: '🌊 다른 유형과의 시너지' },
            { type: 'p', content: '힐러형은 **인싸형(FE)**의 폭발적인 에너지와 만나면, 팀의 역동성이 극대화됩니다. 힐러형이 팀의 안정감을 확보하면, 인싸형이 그 안정감 위에서 자유롭게 활력을 불어넣을 수 있게 됩니다.' },
            { type: 'h3', content: '📈 성장 & 자기 계발 조언' },
